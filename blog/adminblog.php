	...
	<div id="wrapper2">
		<div id="header" class="container">
			...
			<div id="menu">
				<ul>
					...
					<li><a href="blogtable.php?userid=<?php echo $_GET["userid"];?>">Tableview</a></li>
		...
		<div id="page">
			...
			<?php
				...
				$user=$_SESSION["user"];
				$user_id=$_GET["userid"];
				$sql="SELECT * FROM blogs WHERE user_id= '$user_id' ORDER BY blog_id DESC";
				...
				<div class="post">
					...
					<p class="meta"><span class="date"><?php echo $row['last_date']; ?></span><span class="posted">Posted by <a href="#"><?php echo $user_id; ?></a></span></p>
					...
					<span class="posted">Related To: <?php echo $row['related']; ?></span></p>
						...
						<p class="links"><a href="delete.php?no=<?php echo $row['blog_id']; ?>" title="b0x" class="comments">Remove Post</a></p>
					</div>
				</div>
				<?php }
					if($flag==0)
