...
<div id="wrapper">
	<div id="wrapper2">
		...
		<div id="page">
			<div id="content">
				<div class="post">
					<h2 class="title"><a href="#">Update Your post </a></h2>
...
<?php
				...
				$user=$_SESSION["user"];
				$blog_no=$_GET["no"];
				$sql="SELECT * FROM blogs WHERE blog_id= '$blog_no'";
...
<b>Related:</b>
&nbsp;
<input type="text" name="related" value="<?php echo $row['related'];?>" class="form-control" >
<br>
<b>Content:</b>
<textarea name="content"   style="height:200px; width:510px;" class="form-control"> <?php echo $row['content'];?></textarea>
<br>
<b>Image:</b>
