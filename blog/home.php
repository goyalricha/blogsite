		...
		<div id="page">
			...
			<?php
				...
				<div class="post" >
					...
					<div class="entry">
					<span class="posted"><strong><p class="bg-info"> Related To:</strong> <?php echo $row['related']; ?></span>
					 </br><?php echo $row['content']; ?></p>
						<?php $image_name=$row['image'];
						//echo $image_name;?>
						<center><p class="bg-success"><a href="see1.php?imagename=<?php echo $image_name; ?>"><?php echo "<img src='photos/$image_name' alt='Smiley face' class='img-thumbnail'>";?></a></p></center>
